    ...
    {   //zmienne sterujacae kkalwiszmi
        ...
        public void Draw(SpriteBatch sprinteBatch)//wyswietlanie
        {
            if (!start)
            {
                ...
                sprinteBatch.Draw(strzalka1, new Vector2(20, (int)(roz.Y - ((enter.Height ) + 20)* 4) ), Color.White);
                sprinteBatch.Draw(strzalka2, new Vector2(20, (int)(roz.Y- ((enter.Height ) + 20)* 3) ), Color.White);
                sprinteBatch.Draw(spacja, new Vector2(20, (int)(roz.Y - ((enter.Height ) + 20)* 2) ), Color.White);
                sprinteBatch.Draw(enter, new Vector2(20, (int)(roz.Y - (enter.Height ) - 20)), Color.White);
                sprinteBatch.Draw(logo, new Vector2((int)((roz.X-logo.Width)/2), 30), Color.White);
                sprinteBatch.DrawString(font,"Q        PAUZA", new Vector2(20, (int)(roz.Y - ((enter.Height) + 10) * 5)), Color.White);
                sprinteBatch.DrawString(font, "ZATWIERDZANIE", new Vector2(40+ enter.Width, (int)(roz.Y - ((enter.Height) + 20) * 1)+20), Color.White);
                sprinteBatch.DrawString(font, "STRZAL", new Vector2(40 + spacja.Width, (int)(roz.Y - ((enter.Height) + 20) * 2)+20), Color.White);
                sprinteBatch.DrawString(font, "WYBOR", new Vector2(40 +strzalka1.Width, (int)(roz.Y - ((enter.Height) + 20) * 3)+20), Color.White);
                sprinteBatch.DrawString(font, "PORUSZANIE STATKIEM", new Vector2(40 + strzalka2.Width, (int)(roz.Y - ((enter.Height) + 20) * 4)+20), Color.White);
